  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="p-6 rounded-2xl border-0 shadow-sm">
          <div className="mb-6">
            <h3 className="text-gray-900">Admission Conversion Rate</h3>
        ...
        <Card className="p-6 rounded-2xl border-0 shadow-sm">
          <div className="mb-6">
            <h3 className="text-gray-900">Job Post Performance</h3>
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={jobPerformanceData}>
              ...
              />
              <Bar dataKey="views" fill="#4DB6E2" radius={[8, 8, 0, 0]} />
      ...
      <Card className="p-6 rounded-2xl border-0 shadow-sm">
        <div className="mb-6">
          <h3 className="text-gray-900">Feedback Summary</h3>
